...
/* Haciendo lo anterior aún no se soluciona el problema de poder usarlo en el exterior y directamente por ejemplo en el app.component.html ya que también tenemos que decirle a la aplicación de Angular que dispone de este módulo para poder trabajar y usar todo lo que ofrece y para eso hay que agregar el CounterModule en el app.module.ts en imports: [] */
@NgModule({
